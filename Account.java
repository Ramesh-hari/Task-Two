...
public class Account {
    // 1.3 Create a class Account with data member as balance and Perform following tasks a,b,c
    ...
    public void displayBalance(Account amount) {
        System.out.println("Your Account current balance : " + this.balance);
    }
    // Output: Your Account current balance : Display user account balance
}